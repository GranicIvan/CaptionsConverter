...
namespace CaptionsConverter.GUI.Views
{
    public partial class SettingsView : UserControl
    {
        ...
        private void LoadFileHandlingSettings()
        {
            AutoOpenFolderCheckBox.IsChecked = ConfigurationManager.Settings.AutoOpenOutputFolder;
        }

        private void LoadConversionSettings()
        {
            ShowDetailedLogsCheckBox.IsChecked = false;
        }

        private void LoadUIPreferences()
        {
            ConfirmBeforeConversionCheckBox.IsChecked = ConfigurationManager.Settings.ConfirmBeforeConversion;
        }
        ...
        private void SaveSettings_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ConfigurationManager.SetAutoOpenFolder(AutoOpenFolderCheckBox.IsChecked == true);
                ConfigurationManager.SetConfirmBeforeConversion(ConfirmBeforeConversionCheckBox.IsChecked == true);
